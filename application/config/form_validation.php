...
array(
	...
	"cuentas_usuarios" => array(
		array(
			...
			"rules" => "required|min_length[10]|max_length[120]|trim|strip_tags|valid_email",
			"errors" => array(
				"required" => "Por favor debe de ingresar un %s",
		...
		array(
			...
			"rules" => "required|min_length[8]|max_length[255]|trim|strip_tags",
			"errors" => array(
				"required" => "Por favor debe de ingresar una %s",
		...
		array(
			...
			"rules" => "required|min_length[8]|max_length[255]|trim|strip_tags|matches[usu_clave]",
			"errors" => array(
